...
function funcPage() {
  return `<section class="integrated-app func-host" aria-label="FUNC Card Studio"><iframe class="integrated-app-frame" src="/func-app/?v=20260910-photo-editor1" title="FUNC Card Studio" scrolling="yes"></iframe></section>`;
}
